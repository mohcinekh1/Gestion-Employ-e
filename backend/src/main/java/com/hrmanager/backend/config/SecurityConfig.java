...
import com.hrmanager.backend.security.JwtAuthFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/salaries/**").hasAnyRole("ADMIN", "MANAGER")
                        .requestMatchers("/api/absences/**").hasAnyRole("ADMIN", "MANAGER", "EMPLOYEE")
